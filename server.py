    ...
    def do_GET(self):
        ...
        if path == '/':
            ...
            scripts = (
                ...
                '<script src="/order_quantity_truth_patch.js?v=1"></script>'
                '<script src="/recipe_quantity_autofill_patch.js?v=1"></script>'
                '<script src="/recipe_viewer_patch.js?v=1"></script>'
            )
            if '/recipe_viewer_patch.js' not in raw:
        ...
        patch_files = (
            ...
            '/menu_recipe_selector_fix.js', '/order_quantity_truth_patch.js',
            '/recipe_quantity_autofill_patch.js', '/recipe_viewer_patch.js'
        )
