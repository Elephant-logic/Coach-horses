    ...
    def do_GET(self):
        ...
        if path == '/':
            ...
            scripts = (
                ...
                '<script src="/menu_photo_complete_import_patch.js?v=2"></script>'
                ...
                '<script src="/ui_flow_cleanup_patch.js?v=1"></script>'
                '<script src="/prep_safe_patch.js?v=1"></script>'
            )
            if '/prep_safe_patch.js' not in raw:
        ...
        patch_files = (
            ...
            '/menu_recipe_selector_fix.js', '/recipe_viewer_patch.js',
            '/menus_recipes_prep_restore.js', '/menu_owned_recipes_patch.js',
            '/ui_flow_cleanup_patch.js', '/prep_safe_patch.js'
        )
